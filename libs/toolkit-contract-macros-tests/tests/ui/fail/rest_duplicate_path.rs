...
pub trait DemoApi: Send + Sync {
    async fn one(&self, ctx: toolkit_security::SecurityContext, body: String) -> Result<u32, std::io::Error>;
    async fn two(&self, ctx: toolkit_security::SecurityContext, body: String) -> Result<u32, std::io::Error>;
}
