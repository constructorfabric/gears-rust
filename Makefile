...
EXAMPLE_SERVER_FEATURE_EXCLUDES ?= default fips k8s otel timescaledb-usage-collector magika
...
e2e-oop: py-env
	...
	OOP_E2E=1 $(PYTHON) -m pytest $(OOP_E2E_DIR) -c testing/e2e/pytest.ini \
