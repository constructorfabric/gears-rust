...
_CATEGORY_STYLE: dict[str, tuple[str, str, str]] = {
    "constructor-studio": ("rgba(110,60,210,0.06)",  "rgba(110,60,210,0.30)",  "rgba(90,45,190,0.85)"),
...
_NODE_COLORS: dict[str, dict[str, str]] = {
    "constructor-studio": {"background": "#f4eeff", "border": "#7744cc"},
...
const options = {{
  ...
  groups: {{
    ...
    constructor-studio:    {{ color: {{ background: "#f4eeff", border: "#7744cc" }} }},
