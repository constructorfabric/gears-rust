...
Also fires on `POST /v1/subscriptions` (per-tenant JOIN rate cap, default 60/min). Endpoint-specific instance: [single/negative-1.4](../producer/single/negative-1.4-rate-limited.md).
