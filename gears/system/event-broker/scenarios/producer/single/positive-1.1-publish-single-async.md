...
- Supplying a read-only field (`partition`, `sequence`, `sequence_time`) on publish would instead return `400 BadRequest` — see [single/negative-1.3](./negative-1.3-schema-validation-failure.md) for the validation envelope.
