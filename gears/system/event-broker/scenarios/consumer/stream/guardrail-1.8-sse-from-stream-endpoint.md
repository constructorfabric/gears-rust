...
- Run [Cold JOIN](../subscriptions/positive-1.1-cold-join-fresh-group.md) + [SEEK](../positions/positive-1.1-seek-earliest.md) → seeded `{sub_id}`.
...
- No stream established. For SSE, the client must use [`GET /v1/events:sse`](./positive-1.9-sse-event-stream.md).
