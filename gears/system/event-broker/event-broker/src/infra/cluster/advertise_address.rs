//! Advertise-address resolution for `ServiceDiscoveryV1` self-registration
...
/// Resolves the address an instance advertises to `ServiceDiscoveryV1`. The
...
impl AdvertiseAddressResolver for ConfigAdvertiseAddress<'_> {
    fn resolve(&self, bound_addr: SocketAddr) -> anyhow::Result<String> {
        ...
        anyhow::bail!(
            "cannot register with ServiceDiscoveryV1: bound to a wildcard address \
