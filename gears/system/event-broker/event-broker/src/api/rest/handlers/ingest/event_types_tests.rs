...
//! real keyset order).
//! `created_at` is server-generated - extracted from the response and
//! reused to build the exact expected body, rather than skipped.
...
async fn list_event_types_happy_path_returns_all_seeded_types() {
    let harness = EventBrokerHarness::builder()
        .with_type_registry(StaticTypesRegistry::of(json!([
            ...
            {
                "id": "gts.cf.core.events.event_type.v1~x.eb.t1.a.v1",
                "topic": "gts.cf.core.events.topic.v1~x.eb.t1.topic.v1",
            },
            {
                "id": "gts.cf.core.events.event_type.v1~x.eb.t2.b.v1",
...
async fn list_event_types_filters_by_id() {
    ...
    let resp = harness
        ...
        .with_query(
            "$filter",
            "id%20eq%20'gts.cf.core.events.event_type.v1~x.eb.t1.a.v1'",
        )
        .send()
        .await;
...
async fn list_event_types_paginates_with_limit() {
    let harness = EventBrokerHarness::builder()
        .with_type_registry(StaticTypesRegistry::of(json!([
            { "id": "gts.cf.core.events.topic.v1~x.eb.t1.topic.v1", "partitions": 1 },
            {
                "id": "gts.cf.core.events.event_type.v1~x.eb.t1.type0.v1",
                "topic": "gts.cf.core.events.topic.v1~x.eb.t1.topic.v1",
            },
            {
                "id": "gts.cf.core.events.event_type.v1~x.eb.t1.type1.v1",
                "topic": "gts.cf.core.events.topic.v1~x.eb.t1.topic.v1",
            },
            {
                "id": "gts.cf.core.events.event_type.v1~x.eb.t1.type2.v1",
                "topic": "gts.cf.core.events.topic.v1~x.eb.t1.topic.v1",
            },
        ])))
        .build()
    ...
    // expected body (including its server-generated `created_at`) before
    // exercising pagination itself.
