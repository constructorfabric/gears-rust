        ...
        + 'static,
{
    ...
    async fn seek(
        ...
        for (index, (target, topic)) in with_topics.into_iter().enumerate() {
                ...
                .await
            {
                ...
                Err(event_broker_sdk::StorageBackendError::OffsetOutOfRange {
                    ...
                    event_broker_sdk::PositionViolation::builder(index)
                        .floor(floor)
                        .ceiling(ceiling)
                        .breached(breached)
                        .build(),
