...
//! `TopicV1`/`EventTypeV1::TYPE_ID` constants - the same GTS base-type
...
use event_broker_sdk::gts::{
    CONSUMER_GROUP_RESOURCE_TYPE, EventTypeV1, REQUEST_RESOURCE_TYPE, TopicV1,
};
...
pub const EVENT_TYPE_RESOURCE: ResourceType = ResourceType::from_static(EventTypeV1::TYPE_ID, &[]);
