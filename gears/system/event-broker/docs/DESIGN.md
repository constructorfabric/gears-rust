...
| UnknownProducer | 400 | `InvalidArgument` | `invalid_argument` | No | `field_violations: [{field: "Producer-Id", reason: "unknown_producer"}]`, `resource_type: "gts.cf.core.events.topic.v1~"`, `resource_name: <topic>`. The submitted producer id is not echoed |
