...
| `partition` | body, producer-set | body, `readOnly` | Broker derives from `partition_key` or `subject` per [ADR-0002](0001-partition-selection.md); rejected on publish; surfaced on read |
