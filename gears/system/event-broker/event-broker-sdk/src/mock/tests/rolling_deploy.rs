        ...
        .join(
            ...
            JoinRequest {
                ...
                interests: vec![SubscriptionInterest {
                    ...
                    types: vec!["gts.cf.core.events.event_type.v1~test.mock.broker.foo.v1".into()],
                    filter: None,
                }],
        ...
        .join(
            ...
            JoinRequest {
                ...
                interests: vec![SubscriptionInterest {
                    ...
                    max_depth: Some(0),
                    barrier_mode: crate::consumer::backend::BarrierMode::Respect,
                    types: vec!["gts.cf.core.events.event_type.v1~test.mock.broker.bar.v1".into()],
                    filter: None,
                }],
                session_timeout: None,
            },
        ...
        .join(
            ...
            JoinRequest {
                ...
                interests: vec![SubscriptionInterest {
                    ...
                    max_depth: Some(0),
                    barrier_mode: crate::consumer::backend::BarrierMode::Respect,
                    types: vec!["gts.cf.core.events.event_type.v1~test.mock.broker.*.v1".into()],
                    filter: None,
                }],
                session_timeout: None,
            },
        ...
        .join(
            ...
            JoinRequest {
                ...
                interests: vec![SubscriptionInterest {
                    ...
                    max_depth: Some(0),
                    barrier_mode: crate::consumer::backend::BarrierMode::Respect,
                    types: vec!["gts.cf.core.events.event_type.v1~test.mock.broker.v2.*".into()],
                    filter: None,
                }],
                session_timeout: None,
            },
