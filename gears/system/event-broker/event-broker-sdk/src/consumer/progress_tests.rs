...
use super::dispatcher::{
    PartitionCursor, processed_count_from_delivered_offset, processed_count_from_outcome,
};
...
fn event_with_offset(offset: i64) -> RawEvent {
    RawEvent {
        id: Uuid::new_v4(),
        type_id: "gts.cf.core.events.event_type.v1~progress.test".to_owned(),
        topic: "gts.cf.core.events.topic.v1~progress.test".to_owned(),
        tenant_id: Uuid::nil(),
