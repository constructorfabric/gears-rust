...
use event_broker_sdk::{
    ChainMode, EventBrokerError, IngestOutcome, ProducerBackend, ProducerBuilder, ProducerCursor,
    ProducerId, TypedEvent, internal_test_helpers::WireEvent,
};
...
async fn undeclared_type_rejected_without_hitting_backend() {
    ...
    let builder = ProducerBuilder::new_unbound()
        ...
        .source("test-service")
        .chain_mode(ChainMode::Stateless);
