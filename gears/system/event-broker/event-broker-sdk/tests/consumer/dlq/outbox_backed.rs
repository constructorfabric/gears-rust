...
const TOPIC_GTS: &str = "gts.cf.core.events.topic.v1~showcase.outbox.dlq.v1";
const EVENT_TYPE_GTS: &str = "gts.cf.core.events.event_type.v1~showcase.outbox.dlq.v1";
const GROUP_GTS: &str = "gts.cf.core.events.consumer_group.v1~showcase.outbox.dlq.v1";
