...
const TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.inmemory.v1";
const EVENT_TYPE: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.inmemory.v1";
