...
const TX_SINGLE_TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.txsingle.v1";
const TX_SINGLE_EVENT: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.txsingle.v1";
const TX_SINGLE_GROUP: &str = "gts.cf.core.events.consumer_group.v1~test.mock.showcase.txsingle.v1";
const TX_BATCH_TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.txbatch.v1";
const TX_BATCH_EVENT: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.txbatch.v1";
const TX_BATCH_GROUP: &str = "gts.cf.core.events.consumer_group.v1~test.mock.showcase.txbatch.v1";
...
fn raw_event_for_dead_letter() -> event_broker_sdk::RawEvent {
    event_broker_sdk::RawEvent {
        id: Uuid::new_v4(),
        type_id: "gts.cf.core.events.event_type.v1~showcase.db.dlq.v1".to_owned(),
        topic: "gts.cf.core.events.topic.v1~showcase.db.dlq.v1".to_owned(),
        tenant_id: Uuid::nil(),
