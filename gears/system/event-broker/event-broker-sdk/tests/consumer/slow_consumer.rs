...
const SLOW_TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.slow.v1";
const SLOW_EVENT_TYPE: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.slow.v1";
const FAST_TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.fast.v1";
const FAST_EVENT_TYPE: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.fast.v1";
