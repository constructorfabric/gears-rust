...
const TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.customoffset.v1";
const EVENT_TYPE: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.customoffset.v1";

#[derive(Clone)]
struct RecordingOffsetStore {
    loads: Arc<Mutex<Vec<(ConsumerGroupId, TopicId, u32)>>>,
