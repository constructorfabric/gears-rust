...
const TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.routed.v1";
const CREATED: &str = "gts.cf.core.events.event_type.v1~test.mock.routed.created.v1";
const UPDATED: &str = "gts.cf.core.events.event_type.v1~test.mock.routed.updated.v1";
