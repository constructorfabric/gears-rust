...
const TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.batch.v1";
const EVENT_TYPE: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.batch.v1";

struct BatchProjector {
    batches: Arc<Mutex<Vec<(u32, Vec<i64>)>>>,
}
