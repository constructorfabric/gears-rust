...
const TOPIC: &str = "gts.cf.core.events.topic.v1~test.mock.showcase.single.v1";
const EVENT_TYPE: &str = "gts.cf.core.events.event_type.v1~test.mock.showcase.single.v1";
...
async fn if_i_publish_with_a_partition_key_the_handler_can_inspect_it() {
    ...
    super::common::publish_json_with_partition_key(
        &fixture.broker,
        &fixture.ctx,
        TOPIC,
        EVENT_TYPE,
