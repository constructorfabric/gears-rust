...
//!
//! See DESIGN "Domain Model" (envelope entity and output contract) and
//! "Component Model" (codec rules).
...
pub struct TenantIdpMetadataV1 {
    ...
    ///
    /// Per DESIGN "Domain Model": `None` for tenants in the default shared realm
