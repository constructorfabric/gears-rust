...
- **No traceability gaps** for this change. The five `follow-up`-scoped
  requirements are intentionally deferred (PRD §4.1) to the wiring crate and
  parent host gear; their realizing ADR (ADR-006) and DESIGN sections exist, so
