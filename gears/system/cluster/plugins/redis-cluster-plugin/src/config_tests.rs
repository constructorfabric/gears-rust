...
/// The three fields [`RedisClusterConfig`] carries and [`RedisLockConfig`] does
/// not, per DESIGN.md §8: each is meaningless without the cache half.
const CACHE_ONLY_FIELDS: [&str; 3] = [
    "watch_mode",
