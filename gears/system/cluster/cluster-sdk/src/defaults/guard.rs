...
pub(super) fn reject_weak_consistency(
    ...
    // @cpt-begin:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-default
    if consistency == CacheConsistency::EventuallyConsistent {
        // @cpt-begin:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-reject
        ...
        // @cpt-end:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-reject
    }
    // @cpt-end:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-default
    Ok(())
}
...
pub(super) fn warn_weak_consistency(consistency: CacheConsistency, backend: &'static str) {
    // @cpt-begin:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-weak
    // @cpt-begin:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-warn
    tracing::warn!(
        backend,
    ...
    // @cpt-end:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-warn
    // @cpt-end:cpt-cf-clst-algo-sdk-default-backends-constructor-guard:p1:inst-cg-weak
}
...
mod tests {
    ...
    fn warn_emits_split_brain_warning_with_weak_consistency_flag() {
        // Eventually-consistent: the split-brain warning fires with
        ...
        // Linearizable still warns (the opt-in waives the guarantee regardless)
        // but flags the cache class as not weak.
