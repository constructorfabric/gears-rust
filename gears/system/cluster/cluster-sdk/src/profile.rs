...
// @cpt-dod:cpt-cf-clst-dod-sdk-foundation-profile:p1
...
// @cpt-begin:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-define-marker
pub trait ClusterProfile: Copy + Send + Sync + 'static {
    /// The stable profile name. Must satisfy [`CLUSTER_NAME_RULE`].
    const NAME: &'static str;
}
// @cpt-end:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-define-marker
...
pub fn validate_cluster_name(name: &str) -> Result<(), ClusterError> {
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-if-invalid
    if is_valid_cluster_name(name) {
        Ok(())
    } else {
        // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-return-invalid
        // @cpt-begin:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-invalid
        Err(ClusterError::InvalidName {
            name: name.to_owned(),
            reason: CLUSTER_NAME_RULE,
        })
        // @cpt-end:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-invalid
        // @cpt-end:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-return-invalid
    }
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-if-invalid
}
...
pub fn profile_scope(name: &str) -> Result<ClientScope, ClusterError> {
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-validate
    // @cpt-begin:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-validate
    validate_cluster_name(name)?;
    // @cpt-end:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-validate
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-validate
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-compose
    let scope = ClientScope::new(format!("cluster:{name}"));
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-compose
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-return
    // @cpt-begin:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-return-scope
    Ok(scope)
    // @cpt-end:cpt-cf-clst-flow-sdk-foundation-declare-profile:p1:inst-return-scope
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-profile-scope:p1:inst-ps-return
}
