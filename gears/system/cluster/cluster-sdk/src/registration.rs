...
// @cpt-dod:cpt-cf-clst-dod-registration-observability-helpers:p1
...
pub fn register_cache_backend(
    ...
    // @cpt-begin:cpt-cf-clst-algo-registration-observability-scope-register:p1:inst-sr-scope
    let scope = profile_scope(profile)?;
    // @cpt-end:cpt-cf-clst-algo-registration-observability-scope-register:p1:inst-sr-scope
    // @cpt-begin:cpt-cf-clst-algo-registration-observability-scope-register:p1:inst-sr-register
    // @cpt-begin:cpt-cf-clst-flow-registration-observability-register:p1:inst-rb-register
    hub.register_scoped::<dyn ClusterCacheBackend>(scope, backend);
    // @cpt-end:cpt-cf-clst-flow-registration-observability-register:p1:inst-rb-register
    // @cpt-end:cpt-cf-clst-algo-registration-observability-scope-register:p1:inst-sr-register
    Ok(())
}
...
pub fn deregister_cache_backend(hub: &ClientHub, profile: &str) -> Result<bool, ClusterError> {
    let scope = profile_scope(profile)?;
    // @cpt-begin:cpt-cf-clst-algo-registration-observability-scope-register:p1:inst-sr-deregister
    // @cpt-begin:cpt-cf-clst-flow-registration-observability-register:p1:inst-rb-deregister
    Ok(hub
        .remove_scoped::<dyn ClusterCacheBackend>(&scope)
        .is_some())
    // @cpt-end:cpt-cf-clst-flow-registration-observability-register:p1:inst-rb-deregister
    // @cpt-end:cpt-cf-clst-algo-registration-observability-scope-register:p1:inst-sr-deregister
}
