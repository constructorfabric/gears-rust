...
// @cpt-dod:cpt-cf-clst-dod-sdk-foundation-error-model:p1
...
pub enum ProviderErrorKind {
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-conn
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-conn-set
    /// The connection to the backend was lost or dropped; retryable once the
    /// connection is re-established.
    ConnectionLost,
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-conn-set
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-conn
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-timeout
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-timeout-set
    /// A backend operation timed out; retryable.
    Timeout,
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-timeout-set
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-timeout
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-auth
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-auth-set
    /// Authentication against the backend failed; not retryable without
    /// operator intervention.
    AuthFailure,
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-auth-set
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-auth
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-exhaust
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-exhaust-set
    /// The backend rejected the operation due to resource exhaustion;
    /// retryable with backoff.
    ResourceExhausted,
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-exhaust-set
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-exhaust
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-else
    // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-other-set
    /// Any other backend error; not retryable by default.
    Other,
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-other-set
    // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-else
}
...
impl ProviderErrorKind {
    ...
    pub fn is_retryable(self) -> bool {
        // @cpt-begin:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-return
        matches!(
            self,
            Self::ConnectionLost | Self::Timeout | Self::ResourceExhausted
        )
        // @cpt-end:cpt-cf-clst-algo-sdk-foundation-error-classify:p1:inst-ec-return
    }
}
...
impl ClusterError {
    ...
    #[must_use]
    pub fn is_retryable(&self) -> bool {
        // @cpt-begin:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-retry
        // @cpt-begin:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-retry-set
        // @cpt-begin:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-prov-no
        // @cpt-begin:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-prov-no-set
        // @cpt-begin:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-term
        // @cpt-begin:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-term-set
        matches!(self, Self::Provider { kind, .. } if kind.is_retryable())
        // @cpt-end:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-term-set
        // @cpt-end:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-term
        // @cpt-end:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-prov-no-set
        // @cpt-end:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-prov-no
        // @cpt-end:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-retry-set
        // @cpt-end:cpt-cf-clst-algo-watch-auto-restart-classify:p1:inst-cl-retry
    }
}
