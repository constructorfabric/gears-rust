...
// @cpt-dod:cpt-cf-clst-dod-registration-observability-obs:p1
...
pub mod spans {
    ...
    /// Span covering `LockGuard::extend`.
    pub const LOCK_EXTEND: &str = "cluster.lock.extend";
...
pub mod metrics {
    // @cpt-begin:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-emit
    ...
    // @cpt-end:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-emit
}
...
pub mod fields {
    ...
    pub mod attr {
        // @cpt-begin:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-highcard
        // @cpt-begin:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-attr
        /// A cache key.
        ...
        // @cpt-end:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-attr
        // @cpt-end:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-highcard
    }
}
...
// @cpt-begin:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-labels
...
// @cpt-end:cpt-cf-clst-algo-registration-observability-emit-names:p1:inst-en-labels
...
/// they are derived from a [`ClusterError`] by [`result_label`], never from a
/// free-form string. Keeping them bounded preserves the cardinality rule.
pub mod result {
...
pub(crate) fn emit_provider_error(
