...
* a content revision of a v0 Type Schema that narrows, widens, or is incomparable to the current revision is admitted, and the equivalent revision of a v1 Type Schema is rejected;
