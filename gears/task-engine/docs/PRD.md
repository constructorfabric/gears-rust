...
- [PRD — Task Engine](#prd--task-engine)
  ...
  - [2. Actors](#2-actors)
    - [2.1 Human Actors](#21-human-actors)
      ...
      - [API Consumer (Developer)](#api-consumer-developer)
    - [2.2 System Actors](#22-system-actors)
      - [Worker (Task Consumer)](#worker-task-consumer)
  ...
  - [5. Functional Requirements](#5-functional-requirements)
    - [5.1 Task — Core Work Unit](#51-task--core-work-unit)
      ...
      - [Structured Input/Output](#structured-inputoutput)
    ...
    - [5.2 Queue + Concurrency Control](#52-queue--concurrency-control)
      - [Priority-Ordered Dispatch](#priority-ordered-dispatch)
      - [Queue Concurrency Limits](#queue-concurrency-limits)
      - [Task Type Concurrency Limits](#task-type-concurrency-limits)
      - [Concurrency Limit Overrides](#concurrency-limit-overrides)
      - [Runtime Configuration Updates](#runtime-configuration-updates)
      - [Queue Introspection](#queue-introspection)
    - [5.3 Scheduling + Timeouts](#53-scheduling--timeouts)
      - [Delayed / Scheduled Enqueue](#delayed--scheduled-enqueue)
      - [Multi-Type Timeout Enforcement](#multi-type-timeout-enforcement)
      - [Priority Aging / Fairness](#priority-aging--fairness)
    - [5.4 Wait Conditions / Durable Suspension](#54-wait-conditions--durable-suspension)
      - [Wait Condition Framework](#wait-condition-framework)
      - [Timer Wait Condition](#timer-wait-condition)
      - [Event Wait Condition](#event-wait-condition)
      - [Event Wait Condition — Match Expression](#event-wait-condition--match-expression)
      - [Input Wait Condition](#input-wait-condition)
    - [5.5 Task Entries](#55-task-entries)
      - [Fine-Grained Execution Records](#fine-grained-execution-records)
    - [5.6 Assignment + Atomic Claim + Lease](#56-assignment--atomic-claim--lease)
      - [Atomic Claim with Lease](#atomic-claim-with-lease)
      - [Heartbeat / Lease Renewal](#heartbeat--lease-renewal)
      - [Worker Blacklisting](#worker-blacklisting)
      - [Reassignment / Handoff](#reassignment--handoff)
    - [5.7 Progress Tracking](#57-progress-tracking)
      - [Multi-Dimensional Progress](#multi-dimensional-progress)
    ...
    - [5.9 Dependencies / Parent-Child Execution](#59-dependencies--parent-child-execution)
      - [Parent/Child Task Hierarchies](#parentchild-task-hierarchies)
      - [Predecessor/Successor Dependencies](#predecessorsuccessor-dependencies)
    ...
    - [5.11 Authentication and Authorization](#511-authentication-and-authorization)
      - [Authentication via AuthN Resolver](#authentication-via-authn-resolver)
      - [Authorization via PolicyEnforcer (PEP)](#authorization-via-policyenforcer-pep)
      - [Tenant Scoping and Hierarchy](#tenant-scoping-and-hierarchy)
      - [Resource-Path Access Policies](#resource-path-access-policies)
    - [5.12 GTS Extension Points](#512-gts-extension-points)
      - [Task Type as GTS Base Type](#task-type-as-gts-base-type)
      - [Queue as GTS Base Type](#queue-as-gts-base-type)
      - [Task State and Result Code Domain Enums](#task-state-and-result-code-domain-enums)
      - [Task Entry Type as GTS Base Type](#task-entry-type-as-gts-base-type)
    ...
    - [5.15 Observability](#515-observability)
      - [Instrumentation and Metrics](#instrumentation-and-metrics)
    ...
    - [5.19 Task Domain Routing](#519-task-domain-routing)
      - [Multi-Database Storage Domains](#multi-database-storage-domains)
    - [5.20 Caching Layer](#520-caching-layer)
      - [Cluster-Backed Ready-Task Cache](#cluster-backed-ready-task-cache)
    - [5.21 Rate Limiting](#521-rate-limiting)
      - [Per-Tenant and Per-Queue Rate Limits](#per-tenant-and-per-queue-rate-limits)
    - [5.22 Recurring / Cron Tasks](#522-recurring--cron-tasks)
      - [Recurring Schedules](#recurring-schedules)
  - [6. Non-Functional Requirements](#6-non-functional-requirements)
    - [6.1 Gear-Specific NFRs](#61-gear-specific-nfrs)
      - [Claim Latency](#claim-latency)
      - [Throughput](#throughput)
      - [Cache Degradation](#cache-degradation)
      - [Timer Accuracy](#timer-accuracy)
      - [Tenant Isolation](#tenant-isolation)
      - [Request Payload Limits](#request-payload-limits)
  ...
  - [7. Public Library Interfaces](#7-public-library-interfaces)
    - [7.1 Public API Surface](#71-public-api-surface)
      - [Task Engine Client Trait (`task-engine-sdk`)](#task-engine-client-trait-task-engine-sdk)
      - [GTS Type Definitions (`task-engine-sdk`)](#gts-type-definitions-task-engine-sdk)
    - [7.2 External Integration Contracts](#72-external-integration-contracts)
      - [Task Engine REST API Contract](#task-engine-rest-api-contract)
  - [8. Use Cases](#8-use-cases)
      - [Create, Claim, and Execute a Task](#create-claim-and-execute-a-task)
      - [Task Waits for External Event](#task-waits-for-external-event)
      - [Retry with Backoff After Transient Failure](#retry-with-backoff-after-transient-failure)
