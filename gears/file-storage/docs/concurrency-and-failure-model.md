...
| finalize/report callback | 10 s per attempt, up to 3 attempts × 100 ms delay (transport errors only → ≈30.2 s worst case) | sidecar → control callbacks | `FS_SIDECAR_FINALIZE_TIMEOUT_SECS`, `bin/sidecar.rs` |
