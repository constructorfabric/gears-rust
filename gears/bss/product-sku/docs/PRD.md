...
- **Price resolution / override precedence / tier-volume-hybrid-commitment math / FX / `pricingSnapshotRef` composition** → `PRD-tariffs-pricing-logic-202604011200`.
- **Usage → RatedCharge → BillableItem** → `PRD-rating-engine-202604031200`. **Subscription lifecycle** → `PRD-subscriptions-lifecycle-202604021200`. **Marketplace vendor ops (§4.8)** → `PRD-product-catalog-marketplace-202601120119`.
...
- **PRD-tariffs-pricing-logic-202604011200** / **PRD-rating-engine-202604031200** — downstream consumers of published SKUs and `CatalogVersion`; own evaluation and charging respectively.
...
**ID**: `cpt-cf-bss-product-sku-actor-product-manager`
...
**ID**: `cpt-cf-bss-product-sku-actor-catalog-admin`
...
**ID**: `cpt-cf-bss-product-sku-actor-finance-reviewer`
...
**ID**: `cpt-cf-bss-product-sku-actor-auditor`
...
**ID**: `cpt-cf-bss-product-sku-actor-platform-owner`
...
**ID**: `cpt-cf-bss-product-sku-actor-plan-price`
...
#### Tariffs / Pricing Logic

**ID**: `cpt-cf-bss-product-sku-actor-tariffs`

**Role**: Consumes published SKU refs + `CatalogVersion` for price resolution. No authoring here.

#### Rating & Charging

**ID**: `cpt-cf-bss-product-sku-actor-rating`

**Role**: Consumes metering-unit declaration and published SKU refs to map usage.

#### OSS Metering

**ID**: `cpt-cf-bss-product-sku-actor-oss-metering`

**Role**: Emits usage values (external); consumes the metering-unit **declaration** on usage SKUs.

#### Subscriptions

**ID**: `cpt-cf-bss-product-sku-actor-subscriptions`
...
**ID**: `cpt-cf-bss-product-sku-actor-contracts`
...
**ID**: `cpt-cf-bss-product-sku-actor-billing`
...
**ID**: `cpt-cf-bss-product-sku-actor-oss-ams-idp`
...
> **Content boundary**: FRs define WHAT the registry must do, not schemas. Any concrete field/flag/event/idempotency-key name or format is an illustrative handle; canonical field schemas, formats/regexes, error codes, event catalog, and payloads are owned by `DESIGN-product-sku-management-*`. Full Given/When/Then acceptance detail is preserved in §12; interim configurable-policy defaults are in §17.1.

### 6.1 Identifiers & Integrity

#### Identifier contract

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-identifier-contract`
...
**Actors**: `cpt-cf-bss-product-sku-actor-catalog-admin`

#### Reference-signal sourcing, freshness & counting

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-reference-signal`
...
**Actors**: `cpt-cf-bss-product-sku-actor-plan-price`

#### Immutable-field correction (zero-reference & break-glass)

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-immutable-field-correction`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-create-product`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-manage-taxonomy`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-define-sku`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-metering-unit-declaration`

Declaring a metering unit **MUST** validate it against the configured recognized-unit set and reject an unrecognized unit unless elevated approval marks a new validated unit. A usage SKU declares **exactly one** unit (single-dimension); multi-dimension usage **MUST** be expressed via separate SKUs composed at plan/bundle level. A draft whose unit was `deprecated` before first publish **MUST** be treated as a new declaration and rejected. The declared unit **MUST** be carried on publish; this PRD **MUST NOT** compute charges.
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-metering-unit-delisting`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-plantier-classification`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-accounting-codes`
...
**Actors**: `cpt-cf-bss-product-sku-actor-finance-reviewer`

### 6.4 Attributes & Localization

#### Localized attributes, well-known display fields, and definition lifecycle

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-localized-attributes`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-revision-vs-version`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-lifecycle-transitions`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-parent-child-integrity`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-deprecation`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-undeprecation`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-retirement-eol`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-catalog-version-publish`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-snapshot-reproducibility`
...
**Actors**: `cpt-cf-bss-product-sku-actor-billing`

#### Cross-module snapshot freeze atomicity

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-freeze-atomicity`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-freeze-recovery`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-freeze-participant-governance`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-grandfathering-invariant`
...
**Actors**: `cpt-cf-bss-product-sku-actor-subscriptions`

#### Uncomposed-bundle adoption guard

- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-bundle-adoption-guard`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-materiality-gated-publish`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-idempotent-authoring`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-registry-eventing-audit`
...
**Actors**: `cpt-cf-bss-product-sku-actor-events-audit`

#### Event schema versioning & replay

- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-event-versioning-replay`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-tenant-isolation-breakglass`
...
**Actors**: `cpt-cf-bss-product-sku-actor-platform-owner`

#### Break-glass action scope

- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-breakglass-action-scope`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-cache-first-browse`
...
**Actors**: `cpt-cf-bss-product-sku-actor-presentation`

### 6.9 Bulk Operations

#### Bulk import/export

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-bulk-import-export`
...
- [ ] `p3` - **ID**: `cpt-cf-bss-product-sku-fr-clone`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-retention-erasure`
...
**Actors**: `cpt-cf-bss-product-sku-actor-auditor`

### 6.12 Cross-PRD Consistency

#### Registry ↔ plan-price seam

- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-plan-price-seam`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-monetization-traceability`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-expected-failure-behavior`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-event-delivery-resilience`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-catalog-publish-concurrency`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-failsafe-tripwire`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-skucode-reservation-concurrency`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-reference-producer-registration`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-fr-grandfathered-retention-coupling`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-fr-prepublish-lint`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-read-latency`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-read-throughput`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-nfr-publication-propagation`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-posting-safe-budget`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-snapshot-archival-dr`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-scale-extensibility`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-nfr-graceful-degradation`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-determinism-integrity`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-backward-compatible-evolution`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-nfr-availability-audit`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-interface-authoring-publish`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-interface-read-model`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-contract-registry-events`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-contract-sku-reference-count`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-contract-freeze-ack`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-contract-bundle-composition-signal`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-usecase-product-sku-editor`

**Actor**: `cpt-cf-bss-product-sku-actor-product-manager`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-usecase-approval-publish`

**Actor**: `cpt-cf-bss-product-sku-actor-finance-reviewer`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-usecase-lifecycle-deprecation`

**Actor**: `cpt-cf-bss-product-sku-actor-catalog-admin`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-usecase-catalog-browser-history`

**Actor**: `cpt-cf-bss-product-sku-actor-auditor`
...
- [ ] `p1` - **ID**: `cpt-cf-bss-product-sku-usecase-bulk-operations`
...
- [ ] `p2` - **ID**: `cpt-cf-bss-product-sku-usecase-freeze-monitoring`
...
| Tariffs — Commercial Pricing Logic | `docs/bss/prd/PRD-tariffs-pricing-logic-202604011200/PRD-tariffs-pricing-logic-202604011200.md` | Price evaluation over the primitives plan-price authors |
| Rating Engine | `docs/bss/prd/PRD-rating-engine-202604031200/PRD-rating-engine-202604031200.md` | Consumer of metering-unit declaration and published SKU refs |
...
*Child artifacts: ADR(s) for versioning/snapshot strategy and lifecycle/deprecation modeling; DESIGN (`DESIGN-product-sku-management-*`) for entity schemas, APIs, events, and read-model design; STORY documents per scope item. The §4.1 registry↔commercial decomposition is recorded in the manifest §4.1 Decomposition (BSS realization) note, not a separate ADR.*
