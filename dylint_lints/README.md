...
### Testing (DE11xx)
- ✅ DE1101: Tests must be in separate files across the repository for easier LOC filtering, easier navigation for humans and LLMs, and strict separation so tests never contain production logic
