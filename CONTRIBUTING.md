...
Use any supported IDE agent (Windsurf, Cursor, Claude, Copilot) — each redirects to the canonical workflows via `/cf-sdlc-pr-review` and `/cf-sdlc-pr-status` commands.
