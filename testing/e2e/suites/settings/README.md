...
E2E_BASE_URL=http://localhost:8087 \
  testing/e2e/.venv/bin/python -m pytest testing/e2e/suites/settings -vv
```

Run specific test file:
```bash
E2E_BASE_URL=http://localhost:8087 \
  testing/e2e/.venv/bin/python -m pytest testing/e2e/suites/settings/test_settings_get.py -vv
```

Run specific test:
```bash
E2E_BASE_URL=http://localhost:8087 \
  testing/e2e/.venv/bin/python -m pytest testing/e2e/suites/settings/test_settings_patch.py::test_patch_settings_theme_only -vv
```
