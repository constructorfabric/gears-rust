...
// ── ADR-0001 golden-vector contract (M6: expected values are PINNED LITERALS) ──
...
// If this test ever fails, the hash algorithm drifted — update only after verifying ADR-0001.
#[test]
fn golden_uuid_partition_16_pinned() {
    ...
    assert_eq!(
        ...
        pinned,
        "partition_for drifted from pinned value — check ADR-0001 golden vectors"
    );
}
