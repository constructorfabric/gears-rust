...
Tenants are represented as RG groups with `is_tenant = true`. The plugin reads tenant data via `ResourceGroupReadHierarchy` (bypass AuthZ) and maps RG groups to `TenantInfo`/`TenantRef` models.
